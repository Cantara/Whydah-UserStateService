...
public class UIResource {
	...
	private Response toHome(boolean accesstokenFound, Map<String, Object> model) {
    	...
    	if(accesstokenFound) {
        	...
        	model.put("number_of_recent_deleted_users", String.valueOf(service.getNumberOfRecentDeletedUsers()) + " deleted in " + AppSettings.RECENT_DELETED_PERIOD_IN_DAY + " days" );
