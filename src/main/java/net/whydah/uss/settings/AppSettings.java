...
public interface AppSettings extends HibernateJdbcSettings, MailSettings, WhydahSettings {
	...
	int THRESHOLD_FOR_OLD_USER_DETECTION_IN_MONTH = Integer.valueOf(MainApplication.instance.config().get("app.threshold_for_detecting_old_users_in_month", "690"));
	...
	int ERROR_LEVEL = 0;
	int TIME_WAIT_FOR_USER_FETCH_WITH_PAGINATION_FROM_UAS_IN_MILLISECONDS = 1000;
